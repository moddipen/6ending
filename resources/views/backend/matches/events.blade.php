...
@if($get_match_events->count() > 0)
<div class="row mb-3">
    <div class="col-6"><div class="bd-highlight text-left"><h3 class="mb-0"><b> @yield('match')</b></h3></div></div>
    <div class="col-6">
        <div class="float-right  w-25">
            <a data-toggle="modal" data-backdrop="false" data-target="#placed-bet" href="#" class="btn btn-success bet-placed w-100" data-toggle="tooltip" title="" data-original-title="Placed Bets">
                Bets
            </a>
        </div>
    </div>    
