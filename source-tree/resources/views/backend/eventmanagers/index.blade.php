...
<div class="card">
    <div class="card-body">
        ...
        <div>
            <div class="row mt-4">
                <div class="col">                  
                    <table class="table table-hover table-responsive-sm" id="event-list">
                        <thead>
                            <tr>
                                <th>Match</th>
                                <th>Event</th>
...
@push ('after-scripts')
<script>
    var eventList = '{{ route("backend.$module_name.datatable") }}';
    var routeWinCoinUpdate = '{{ route("backend.$module_name.update") }}';
